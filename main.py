...
def check_mail(mail=''):
    ...
    if length == 0:
        print('[INFO] There are no new messages in the mail yet. The check occurs automatically every 5 seconds!')
    else:
        id_list = []
        ...
        print(f'[INFO] You have {length} new message! The check occurs automatically every 5 seconds!')
...
def main():
    try:
        ...
        print(f'[ * ] Your postal address: {mail}')
